...
QMatrix4x4 PerspectiveCamera::getPerspectiveMatrix(float n, float f, float l, float r, float b, float t)
{
    return getPerspectiveMatrixMethod2(n, f, l, r, b, t);
}

QMatrix4x4 PerspectiveCamera::getPerspectiveMatrixMethod1(float n, float f, float l, float r, float b, float t)
{
